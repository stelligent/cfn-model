...
class ApiGatewayStageParser
  ...
  def parse(cfn_model:, resource:)
    ...
    attach_usage_plans_to_api_stage(cfn_model: cfn_model, api_stage: api_stage)
  ...
  def attach_usage_plans_to_api_stage(cfn_model:, api_stage:)
    ...
    usage_plans.select do |usage_plan|
      ...
      usage_plan.apiStages.select do |up_api_stage|
  ...
  def attach_deployment_id_to_api_stage(cfn_model:, api_stage:)
    ...
    api_deployments.select do |deployment|
