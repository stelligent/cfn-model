...
def security_group_with_one_ingress_rule_ipprotocol(security_group_id: 'sg3', ingress_group_id: nil)
  ingress_rule = AWS::EC2::SecurityGroupIngress.new
  ingress_rule.cidrIp = '10.1.2.3/32'
...
def standalone_ingress_rule_ip_protocol
  expected_ingress_rule = AWS::EC2::SecurityGroupIngress.new
...
def security_group_with_one_egress_rule_ipprotocol(security_group_id: 'sg3', ingress_group_id: nil)
  egress_rule = AWS::EC2::SecurityGroupEgress.new
...
def standalone_egress_rule_ip_protocol
  expected_egress_rule = AWS::EC2::SecurityGroupEgress.new
